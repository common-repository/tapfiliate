 ...
 */
function tapfiliate_product_create_commission_type(): void
{
    $args = array(
...
add_action('woocommerce_product_options_general_product_data', 'tapfiliate_product_create_commission_type');

/**
 * Saves WooCommerce product custom fields.
 */
function tapfiliate_product_save_commission_type(int $post_id): void
{
    $product = wc_get_product($post_id);
    $custom_fields_woocommerce_title = $_POST['tapfiliate_product_commission_type'] ?? '';
 ...
 */
function tapfiliate_category_add_commission_type(): void
{
    ?>
 ...
 * @param mixed $term
 */
function tapfiliate_category_edit_commission_type($term): void
{
    // Get term ID
    ...
    ?>
    <tr class="form-field">
        <th scope="row" style="vertical-align: top"><label for="tapfiliate_category_commission_type"><?php _e('Tapfiliate Commission Type', 'wh'); ?></label></th>
        <td>
 ...
 * @param mixed $term_id
 */
function tapfiliate_save_category_commission_type($term_id): void
{
...
add_action('edited_product_cat', 'tapfiliate_save_category_commission_type');
add_action('create_product_cat', 'tapfiliate_save_category_commission_type');
